    ...
    <div className='border-2 border-purple-600 m-10 max-w-4xl mx-auto rounded-md'>
      ...
      <div className="w-full grid place-content-center">
        <div className="flex shrink-0 px-10 m-10 gap-5 rounded-xl max-md- justify-center items-center">
          <button onClick={()=>setCount(count - 1)} className='bg-red-300 py-2 px-5 rounded-md cursor-pointer'>Decrement</button>
          <h1>0</h1>
          <button onClick={()=>setCount(count + 1)} className='bg-red-300 py-2 px-5 rounded-md cursor-pointer'>Increment</button>
